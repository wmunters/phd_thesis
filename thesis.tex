\documentclass[faculty=firw,department=wtk,phddegree=wtk,final]{adsphd}
...
%%% COVER: Settings %%%
	\title{Large-eddy simulation and optimal coordinated control of wind-farm boundary layers}

	\author{Wim}{Munters}
	\supervisor{Prof.~dr.~ir.~J.~Meyers}{}
	\president{Prof.~dr.~A.~Bultheel}
	\jury{Prof.~dr.~N.~van~Lipzig\\Prof.~dr.~ir.~G.~Samaey}
	\externaljurymember{Prof.~dr.~ir.~J.-W.~van Wingerden}{Delft University of Technology, Netherlands}
	\externaljurymember{Prof.~dr.~ir.~S.~Ivanell}{KTH and Uppsala University, Sweden}
