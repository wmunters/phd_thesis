...
\subsection{Uniform inflow}\label{sec:opt_yaw_uniform}
	...
	\begin{figure}
		...
		\caption[Instantaneous planviews at hub height for uniform inflow cases R, Y, I3, and I3Y at $t= 450$ s.]{Instantaneous planviews at hub height for uniform inflow cases R, Y, I3, and I3Y at $t= 450$ s. \emph{Top: } Streamwise velocity. \emph{Bottom: } Wall-normal vorticity. \label{fig:flowfield_uniform}}
	\end{figure}
...
\subsection{Turbulent inflow}\label{sec:opt_yaw_turb}
	...
	\begin{figure}
		...
		\caption[Instantaneous planviews at hub height for turbulent inflow cases at $t= 450$ s.]{Instantaneous planviews at hub height for turbulent inflow cases at $t= 450$ s. \emph{Top: } Streamwise velocity. \emph{Bottom: } Wall-normal vorticity. \label{fig:flowfield_turb}}
	\end{figure}
